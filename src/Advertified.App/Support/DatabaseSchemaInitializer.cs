        ...
        foreach (var relativePath in new[]
                 {
                     ...
                     Path.Combine("database", "bootstrap", "037_prospect_leads.sql"),
                      ...
                      Path.Combine("database", "bootstrap", "040_broadcast_batch_activation.sql"),
                      ...
                      Path.Combine("database", "bootstrap", "047_digital_pricing_markup.sql"),
                      ...
                      Path.Combine("database", "bootstrap", "069_lead_ops_conversion_foundation.sql"),
                     ...
                     Path.Combine("database", "bootstrap", "077_recommendation_selection_state.sql"),
                     Path.Combine("database", "bootstrap", "078_business_process_visibility.sql")
                     })
        {
