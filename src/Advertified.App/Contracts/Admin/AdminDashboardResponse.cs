...
public sealed class AdminDashboardResponse
{
    ...
    public IReadOnlyList<AdminIndustryStrategyProfileResponse> IndustryStrategyProfiles { get; set; } = Array.Empty<AdminIndustryStrategyProfileResponse>();
...
public sealed class AdminIndustryStrategyProfileResponse
{
