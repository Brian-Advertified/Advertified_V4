    ...
    <>
      ...
      >
        ...
        <LegalSection title="Payments and service providers">
          <p>Advertified supports payment and billing workflows using Finance Partner providers. Payment status, invoice details, and related transaction references may be stored to fulfil orders and maintain accounting records.</p>
        </LegalSection>
