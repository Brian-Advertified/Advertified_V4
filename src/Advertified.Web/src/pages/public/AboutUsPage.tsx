      ...
      <section className="panel px-6 py-7 sm:px-8 sm:py-8">
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <p className="mt-4 text-sm leading-7 text-ink-soft sm:text-base">
              Advertified supports campaigns across outdoor, radio, TV, social, digital, SMS, and print. Everything is designed to work together so businesses can plan, approve, and execute with less friction.
            </p>
          </div>
