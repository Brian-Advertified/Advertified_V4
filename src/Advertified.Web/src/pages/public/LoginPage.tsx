    ...
    <section className="page-shell">
      ...
      <div className="mx-auto grid max-w-5xl gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        <div className="panel hero-glow px-6 py-8 text-white sm:px-8">
          <div className="pill border-white/10 bg-white/10 text-white/75">Client and agent access</div>
          ...
          <p className="mt-4 text-base leading-8 text-white/75">
            Clients can continue from package purchase into campaign briefing. Agents can move directly into campaign operations and inventory review.
          </p>
          {activated ? (
